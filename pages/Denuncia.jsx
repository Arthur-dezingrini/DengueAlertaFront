...
export default function Denuncia({ navigation, route }) {
  ...
  const [checkedLocal, setCheckedLocal] = useState(denuncia.checkedLocal);
  ...
  useEffect(() => {
    (async () => {
      ...
      if (status !== "granted") {
        setErrorMsg("É necessário a localização para fazer uma denuncia");
        return;
      }
      try {
